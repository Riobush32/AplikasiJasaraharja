    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <form method="post" action="<?= site_url('pengajuan/update') ?>">
            <input type="hidden" name="id" value="<?= $data->id_pengaju ?>">
            <div class="container">
              <div class="row">
               <div class="col-sm-6">
               ...
               <table class="table table-sm">
                ...
                <table class="table">
                  ...
                  <tr>
                    ...
                    <td colspan="5"><input class="form-control" value="<?= $data->tempatkejadian ?>"  type="text" name="tempatkejadian"></td>
                  </tr>
                </table>
                <br>
                <br>
                ...
                <table class="table table-sm">
                  <tr>
                    <td>Nama</td>
                    <td>:</td>
                    <td colspan="4"><input type="" class="form-control" name="nama2"  value="<?= $data->nama2 ?>"></td>
                  </tr>
                  <tr>
                    <td>Tempat & Tgl. Lahir</td>
                    <td>:</td>
                    ...
                    <tr>
                      <td>Alamat</td>
                      <td>:</td>
                      <td colspan="4"><input class="form-control" type="" name="alamat2" value="<?= $data->alamat2 ?>"></td>
                    </tr>
                    <tr>
                      <td></td>
                      <td></td>
