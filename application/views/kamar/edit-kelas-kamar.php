      ...
      <div class="row">
        <div class="col-sm-5 col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="<?= site_url('kelaskamar/update') ?>">
                <input type="hidden" name="id" value="<?= $edit->id_kk ?>">
                <div class="form-group">
                  <label>Nama Kelas Kamar</label>
                  <input type="text" name="nama" class="form-control" value="<?= $edit->nama_kelas ?>">
                </div>
