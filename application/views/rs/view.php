  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Tambah Data Rumah Sakit</h4>
      ...
      <a href="?page=v_buku" class="btn btn-info">Lihat Data</a>
          ...
          <div class="card">
                <div class="card-header">
                  <h5 class="card-title mb-0">Kode RS</h5>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                  <h5 class="card-title mb-0">Nama Rumah Sakit</h5>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                  <h5 class="card-title mb-0">Nama Direktur</h5>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                  <h5 class="card-title mb-0">Nama PIC</h5>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                  <h5 class="card-title mb-0">No Telepon PIC</h5>
                </div>
                <div class="card-body">
                  <input type="text" name="hb" class="form-control">
                </div>
            ...
            <div class="card">
                <div class="card-header">
                  <h5 class="card-title mb-0">No Rek</h5>
                </div>
                <div class="card-body">
                  <input type="text" name="hb" class="form-control">
                </div>
