        ...
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php endif ?>
              <a target="_blank" href="<?= site_url('rumahsakit/cetakobat/'.$rs->IDrs);?>" class="btn btn-success">
                  ...
                  foreach ($obat as $u) :
                    ...
                    <tr>
                      ...
                      <?php if($this->session->userdata('akses') == 1 ) : ?>
                        <td width="100">
                          <center>
                            <a href="<?= site_url('rumahsakit/editobat/' . $u->id_obat) ?>" class="btn btn-primary btn-sm">
                              <i class="fa fa-edit"></i> 
                            </a>
                            <a href="<?= site_url('rumahsakit/deleteobat/' . $u->id_obat) ?>" class="btn btn-danger btn-sm tombol-hapus">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="<?= site_url('rumahsakit/prosesobat') ?>">
