        ...
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
             ...
             <?php endif ?>
             <a target="_blank" href="<?= site_url('rumahsakit/cetakkamar?id='.$rs->IDrs);?>" class="btn btn-success">
                ...
                foreach ($kamar as $u) :
                  ...
                  <tr>
                    ...
                    <?php if($this->session->userdata('akses') == 1 ) : ?>
                      <td width="100">
                        <center>
                          <a href="<?= site_url('rumahsakit/editkamar/' . $u->id_kamar) ?>" class="btn btn-primary btn-sm">
                            <i class="fa fa-edit"></i> 
                          </a>
                          <a href="<?= site_url('rumahsakit/deletekamar/' . $u->id_kamar) ?>" class="btn btn-danger btn-sm tombol-hapus">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="<?= site_url('rumahsakit/proseskamar') ?>">
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="kamar">
                  ...
                  <?php 
                  foreach ($k_kamar as $key ) { ?>
                    <option value="<?= $key->id_kk ?>"><?= $key->nama_kelas ?></option>
                    <?php
                  } ?>
